...
import {
  ...
  type Order, type Customer, type Document, type Printer, type PrinterStatus, type PrinterTechnology,
  type Spool, type Resin, type Powder, type InventoryItem, type UnassignedJob, type ShippingLog,
  type Currency, type MaterialStatus,
} from './workspace-data';

export type { Order, Customer, Document, Printer, PrinterStatus, PrinterTechnology, Spool, Resin, Powder, InventoryItem, UnassignedJob, ShippingLog, Currency, MaterialStatus };
